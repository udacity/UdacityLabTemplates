...
$udacityImageDefinitionNameArray = @("Debianx64DMZOnCloudNewImage","Debianx64DMZwebCMSCloudImage", "DMZIServerImage", "DNSServerImage")
$vmNameArray = @("Debianx64DMZOnCloudNew", "Debianx64DMZwebCMSCloud", "DMZIServer", "DNSServer")
$nicNameArray = @("debianx64dmzoncloudn979", "debianx64dmzwebcmscl163", "dmziserver483", "dnsserver184")
