...
$udacityImageDefinitionNameArray = @("Debianx64DMZwebCMSCloudImage", "DMZIServerImage", "DNSServerImage")
$vmNameArray = @("Debianx64DMZwebCMSCloud", "DMZIServer", "DNSServer")
$nicNameArray = @("debianx64dmzwebcmscl163", "dmziserver483", "dnsserver184")
