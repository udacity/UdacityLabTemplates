...
try
{
  ...
  $labResourceGroupName = "UDACITY-CYBERND03-PROJECT"
  ...
  else
  {
    ...
    $rg = New-AzResourceGroup -Name $labResourceGroupName -Location $labResourceGroupLocation -Tag @{AppCode="UDACITY"; ContentType='LAB'; CourseName='CYBERND03'}
  ...
  $udacityResourceGroup = "ICYBER-ND03-PUBLISH"
  $udacityImageGalleryName = "CYBERND03"
  $udacityImageDefinitionName = "CYBERND03-Student-StudentVM1"
