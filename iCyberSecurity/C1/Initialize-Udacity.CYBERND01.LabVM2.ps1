...
try
{
  ...
  $labResourceGroupName = "UDACITY-CYBERND01-EXERCISE"
  ...
  else
  {
    ...
    $rg = New-AzResourceGroup -Name $labResourceGroupName -Location $labResourceGroupLocation -Tag @{AppCode="UDACITY"; ContentType='LAB'; CourseName='CYBERND01'}
  ...
  $udacityResourceGroup = "ICYBER-ND01-PUBLISH"
  $udacityImageGalleryName = "CYBERND01S"
  $udacityImageDefinitionName = "CYBERND01S-Student-StudentVM2"
